...
<body>
    ...
    <div class="video">
        <video src="./videos/video-home.mp4" muted autoplay loop></video>
    ...
    <footer class="footer">
        <div class="icones">
            <a href="https://wa.me/14998988070" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#25d366" class="bi bi-whatsapp"
                    viewBox="0 0 16 16">
                    <path
            ...
            <a href="https://www.facebook.com/share/12KgmzMdWQm/?mibextid=wwXIfr" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#0866ff" class="bi bi-facebook"
                    viewBox="0 0 16 16">
                    <path
            ...
            <a href="https://www.instagram.com/coop.service25/" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#ff005e" class="bi bi-instagram"
                    viewBox="0 0 16 16">
                    <path
